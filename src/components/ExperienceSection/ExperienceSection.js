...
const ExperienceSection = ({ scrollAnimationList }) => {
    ...
    const handleDownloadClick = async () => {
        try {
            ...
            const response = await fetch("/nicolas-resume.docx");
            if (!response.ok) {
            ...
            link.href = url;
            link.download = "nicolas-resume.docx";
                ...
                <div className={classNames(styles.holder, scrollAnimationList[1] && styles["fade-in"])}>
                    ...
                    <div className={styles["highlight-card"]}>
                        <div className={styles["highlight-holder"]}>
                            ...
                            <div className={styles["highlight"]}>
                                <h5 className={styles["highlight-title"]}>Fullstack Web & Mobile Engineer</h5>
                                <img className={styles["highlight-icon"]} src="dpd-logo.png" />
                                <h6 className={styles["highlight-job-name"]}>DPD Framework</h6>
                                <p className={styles["highlight-date"]}>Apr 2025 - Present</p>
                            </div>
                            <div className={styles["highlight"]}>
                    ...
                    <div>
                        ...
                        <div className={styles["skills-holder"]}>
                            ...
                            <Skill name="React Native" img="skill-icons/react-icon.png" />
                            ...
                            <Skill name="Google Cloud" img="skill-icons/gcp-icon.png" />
                            <Skill name="AWS" img="skill-icons/aws-icon.png" />
                        </div>
                    </div>
                </div>
            </div>
