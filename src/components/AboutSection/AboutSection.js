        ...
        <>
            ...
            <div className={styles.holder}>
                <div className={styles["text-holder"]}>
                    ...
                    <p className={styles["desc-text"]}>A <b>Fullstack Web Developer</b> in San Francisco. Specializing in Responsive Web Design, <b>Nextjs</b>, <b>React</b>, and <b>JavaScript</b></p>
                    <a href="#contact">
